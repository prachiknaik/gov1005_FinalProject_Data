...
saveRDS(school_characteristics_vis, "FinalProject/school_characteristics_vis.rds")
...
rr <- ggplot(data = school_mental_health)+geom_bar(aes(x = school_type, fill = diag_location))
...
#WHY IS THIS GRAPH NOT SHOWING UP\
